#include <bits/stdc++.h>
#include "C:\Users\ManosChatzigeorgiou\Documents\BJ\Core\RTP.cpp"
using namespace std;
...
int main(){
    ...
    ofstream lg2("simResults.txt", ios::app);

    for(int shoe = 0; hands < 30000; shoe++){
        for(int i = 1; i < 10; i++){
